...
dotfiles() {
  case "$1" in
    install)
      shift
      "$HOME/Projects/dotfiles/scripts/install.sh" "$@"
      ;;
    update)
      shift
      "$HOME/Projects/dotfiles/scripts/update.sh" "$@"
      ;;
    stow)
      shift
      "$HOME/Projects/dotfiles/scripts/stow.sh" "$@"
      ;;
    *)
      echo "Usage: dotfiles {install|update|stow} [package]" >&2
      return 1
      ;;
  esac
}
...
||||||| parent of 622ed8b (Adding gitstatus script/helper as well as adding lazybar)
=======
# ─── Git Status helper ────────────────────────────────────────────────────────
# Usage:
#   gitstatus [directory] [options]
...
>>>>>>> 622ed8b (Adding gitstatus script/helper as well as adding lazybar)
